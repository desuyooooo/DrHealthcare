          ...
          <div class="row placeholders">
            ...
            ?>
              <div class="col-md-8">
                 <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation"><?php echo '<a href="viewprofile.php?pid='.$_GET['pid'].'">'.$row["firstname"].'</a>';?></li>
                    <li role="presentation" class="active"><?php echo '<a href="viewactivitylog.php?pid='.$_GET['pid'].'">';?>Activity Log</a></li>
                </ul>
                <br>
            ...
            <div class="col-md-8">
              <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><?php echo '<a href="viewactivitylog.php?did='.$_GET['did'].'">';?>Activity Log</a></li>
